...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XLuaBehaviour);
        ...
        static int _g_get_self(RealStatePtr L)
        {
		    try {
                ...
                XLuaBehaviour __cl_gen_to_be_invoked = (XLuaBehaviour)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.self);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_self(RealStatePtr L)
        {
		    try {
                ...
                XLuaBehaviour __cl_gen_to_be_invoked = (XLuaBehaviour)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.self = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
