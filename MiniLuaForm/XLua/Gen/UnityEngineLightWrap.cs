    ...
    public class UnityEngineLightWrap 
    {
        ...
        static int _g_get_bakingOutput(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Light __cl_gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.bakingOutput);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_bakingOutput(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Light __cl_gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                UnityEngine.LightBakingOutput __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.bakingOutput = __cl_gen_value;
