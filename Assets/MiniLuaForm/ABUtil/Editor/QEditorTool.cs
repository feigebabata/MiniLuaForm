...
public class QEditorTool
{
    ...
    static void AutoSetLabel()
    {
        ...
        //1.找到资源保存的文件夹
        string assetDirectory = Application.dataPath + "/ABRes";
    ...
    [MenuItem("QTool/AB/Bundle Android Label")]
    ...
    static void CreatFiles()
    {
        ...
        GetAllFileName(Direinfo, ref pathList, "concretegame", new List<string>() { "version.txt","concretegameConfig.txt"});
